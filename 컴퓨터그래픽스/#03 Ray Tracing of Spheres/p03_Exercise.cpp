...
render(GLFWwindow* window)
{
	...
	glLineWidth(5 * dpiScaling);
		...
		if (inputMode == InputMode::PRESS2)
		{
			...
			//int arr[9];
			//for (int k = 0; k < 10; k++) {
			//	arr[k] = point[1][0], point[1][1];

			//	glBegin(GL_LINES);
			//	glVertex2f(arr[2*k], arr[2*k + 1]);
			//	glVertex2f(arr[2 * k+2], arr[2 * k + 3]);
			//	glEnd();
			//}
